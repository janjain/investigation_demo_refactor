            ...
            <div id="contents">
                ...
                <div id="contents_placeholder">
					<table id="rprtTable" border="1" cellpadding="0" cellspacing="0">
					  <tbody>
						<tr>
							<td id="formHeader" colspan="2">Cases by List</td>
						</tr>
					...
					<?php // include the file that defines (contains) the username and password
						...
						{
							$qry = "Select * from cases where criteria = 2";
						}
						
						//execute query
						$users = mysqli_query($dbconn, $qry) or die('Query failed: ' . mysql_error($dbconn));
						...
						{ 
							...
							echo "<tr><td>" . $line['case_num'] . "</td><td>" . $line['case_title'] . "</td><td>" . $line['status'] . "</td><td>" . $line['input_by'] . "</td><td>" . $line['case_owner'] . "</td><td>" . $line['criteria'] . "</td><td>" . $line['method_received'] . "</td><td>" . $line['date_opened'] . "</td></tr>";
						}
